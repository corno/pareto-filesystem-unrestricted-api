...
import type * as s_directory_structure from "../../schemas/nested_directory_structure/schema.js"
import type * as s_read_directory_structure from "../../schemas/read_nested_directory_structure/schema.js"
            ...
            ($): p_.Query_Result<s_directory_structure.Node, s_read_directory_structure.Node_Error> => {
                ...
                return p_.decide.state($['node type'], ($) => {
                    switch ($[0]) {
                        ...
                        case 'file': return p_.option($, ($) => p_.e_deprecated.deprecated_direct_result(['file', null]))
