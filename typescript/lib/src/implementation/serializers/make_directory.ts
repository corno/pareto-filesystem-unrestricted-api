...
//schemas
import type * as s_in from "../../interface/schemas/fs_unrestricted_make_directory.js"
    ...
    p_.from.state($.type).decide(
        ($) => {
            switch ($[0]) {
                ...
                case 'directory already exists': return p_.option($, ($) => p_.ph.literal("directory already exists"))
